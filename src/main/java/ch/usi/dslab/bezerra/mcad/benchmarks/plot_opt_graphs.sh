...
outfile=${directory}/optimistic.ps
...
set label "MAX. POWER" font "Helvetica-Bold, 16" center rotate by 90 at 10,0.3

set label "Percentages represent mistakes" at 11.7,0.355
set label "in optimistic delivery" at 11.7,0.2575
set object rect from 11,0.3975 to 19,0.2025 fc rgb "white" fillstyle solid 0.15 noborder
