...
if len(sys.argv) == 4 :
    ...
    if alg == "urp" :
        config_file = script_dir() + "/urp_2g3r.json "
    elif alg == "ridge" :
...
receiver_class = "ch.usi.dslab.bezerra.mcad.recoverytester.RecoveryLearner"

silence_receivers = False
#silence_receivers = True

receiver_cmd = java_bin + " " + debug_server_str + " " + jmx_server_str + " " + libmcast_cp + " " + app_classpath + " " + receiver_class + " " + config_file + " " + receiver_id
