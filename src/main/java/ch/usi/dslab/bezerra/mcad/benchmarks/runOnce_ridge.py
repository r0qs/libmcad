...
sysConfig = generateRidgeSystemConfiguration(nodespool.all(), numGroups, numPxPerGroup, numLearners, 3, writeToDisk, ensemblesConfigPath, partitionsConfigPath, saveToFile=True, mode="DYNAMIC")
if sysConfig == None :
    sys.exit(1)
